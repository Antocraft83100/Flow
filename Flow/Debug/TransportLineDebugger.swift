...
class TransportLineDebugger {
    ...
    func checkDependencies() {
        ...
        let testPolyline = CustomPolyline(coordinates: testCoords, color: .red, lineName: "TEST")
...
"""
        ...
        let lines = TransportLineCSVParser.parseTransportLinesCSV(csvContent: sampleCSV)
