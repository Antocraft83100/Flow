...
Use these types to manage specific types of data when you create a parameter for an app intent 
a property for an app entity.
struct IntentPerson
...
struct IntentItem
A type describing a value returned from a dynamic options provider, plus information about
