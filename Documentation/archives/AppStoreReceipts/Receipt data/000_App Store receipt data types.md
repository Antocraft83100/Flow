# 000_App Store receipt data types.pdf
...
The UUID that an app optionally generates to map a customer’s in-app purchase with its
resulting App Store transaction.
type status
...
App Store Receipts / App Store receipt data types
API Collection
...
The identifier of the promotional offer for an auto-renewable subscription that the user
redeems.
