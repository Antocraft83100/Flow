# 000_Configuring your app licensing environment.pdf

## Page 1

After your developer account qualifies to build an alternative app marketplace, you can use App
License Delivery SDK to secure the installation of your marketplace app and the apps that you
distribute from your alternative marketplace. To set up your development environment for app
licensing:
...
To facilitate generating licenses, create the following App License Delivery (ALD) assets in
...
Overview
Generate alternative marketplace app licensing
assets
App License Delivery SDK / Configuring your app licensing environment
Article
...
Important
Secure your PASK secret as you do other credentials, such as private keys and passwords.
Don’t share your PASK secret, store secrets in a code repository, or include secrets in client or
server code.
