...
thumbnailId
string
(Required) The thumbnail identifier for the thumbnail to retrieve. Format this
value as a URL-encoded string.
200
OK
The request succeeded.
...
Query Parameters
Response Codes
ClassKit Catalog API / Get a Thumbnail
Web Service Endpoint
Get a Thumbnail
Fetch the image for one of your app’s assignable activities.
ClassKit 1.0+
...
thumbnailId
string
(Required) The thumbnail identifier for the thumbnail to delete. Format this
value as a URL-encoded string.
202
Accepted
The API accepted but hasn’t completed the request. To ask for a status upda
...
Query Parameters
Response Codes
ClassKit Catalog API / Delete a Thumbnail
Web Service Endpoint
Delete a Thumbnail
Remove one of the images for your app’s assignable activities.
ClassKit 1.0+
