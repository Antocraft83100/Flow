# 000_Prerelease Versions and Beta Testers.pdf

## Page 1

TestFlight allows you to distribute your apps to beta testers before releasing your apps on the App
Store. You can learn more about TestFlight on the Apple Developer website.
Using the App Store Connect API, you can automate the same tasks you perform in the TestFlight
section of App Store Connect; for example:
...
App Store Connect API / Prerelease Versions and Beta Testers
