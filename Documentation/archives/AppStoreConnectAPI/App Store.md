...
App Clips
Builds
App Store Connect API / App Store
App Store
...
Read metadata for app and App Clip binaries included in a build you upload to App Store
Connect.
Build Icons
...
In-App Purchase
Create and manage in-app purchases, including localizations, price schedules, and
submissions for review.
Auto-Renewable Subscriptions
Create and manage auto-renewable subscriptions, including managing subscription groups
and submissions for review.
Promoted Purchases
Manage promoted in-app purchases and auto-renewable subscriptions, including their
...
Manage submissions for App Store Review for in-app purchases and auto-renewable
subscriptions, including their screenshots.
...
Review submissions
Create and manage your submissions for review, which can include your App Store version,
App Store version experiments, custom product page versions, and in-app events.
Review submission items
Manage the contents of your review submission, which can include your App Store version,
App Store version experiments, custom product page versions, and in-app events.
...
Tell Apple about a noteworthy app or update to an existing one for consideration for featurin
opportunities.
App Store version experiments
Test elements of your App Store product page.
App Store Version Experiment Treatments
Create and update the metadata and the optional icon that represent the treatment you appl
to an App Store version experiment.
App Store Version Experiment Treatment Localizations
Manage the localized assets, including screenshots and previews, for an App Store version
experiment treatment.
App Store Version Promotions
Apply a version experiment treatment to your app’s product page in the App Store, or to you
