# 000_Alternative Marketplaces and Web Distribution.pdf

## Page 1

Use the APIs in this collection to help facilitate the distribution of your apps to users in the EU on 
alternative app marketplace or from your website. To learn more, see Update on apps distributed 
the European Union.
You can set up and configure your apps for alternative distribution and configure interactions with
Apple Services. Use this API to manage:
...
To learn more, see Configuring alternative marketplaces and alternative marketplace apps and
Configuring apps for web distribution.
Configuring alternative marketplaces and alternative marketplace apps
Establish a connection between a marketplace and a marketplace app and configure
marketplace settings.
Overview
Topics
Essentials
App Store Connect API / Alternative Marketplaces and Web Distribution
Alternative Marketplaces and Web
Distribution
