# 003_AddressBook Enumerations.pdf
...
Picker
Errors
Address Book / AddressBook Enumerations
API Collection
...
These constants identify the format to use for a person’s composite name order for person
records.
...
Different possible values for the authorization status of an app with respect to address book
data.
Deprecated
