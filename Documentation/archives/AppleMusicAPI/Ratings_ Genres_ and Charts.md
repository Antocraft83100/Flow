# Ratings_ Genres_ and Charts.pdf
...
Fetch the user’s ratings for one or more library music videos by using the library music video
identifiers.
Get Multiple Personal Library Playlist Ratings
Fetch the user’s ratings for one or more library playlists by using the library playlists’
identifiers.
...
Handling the Response
See Also
Apple Music API / Music Genres
API Collection
Music Genres
Get information about the genres of the user’s music or items in the Apple Music
Catalog.
...
See Also
Ratings, Genres, and Charts
Apple Music API / Charts
API Collection
Charts
Get chart information that shows the popularity of albums, songs, and music
videos.
