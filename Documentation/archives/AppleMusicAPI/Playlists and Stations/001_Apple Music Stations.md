...
Apple Music API / Apple Music Stations
API Collection
...
Playlists
Get the contents of playlists, add new playlists to the user’s library, and add tracks to an
existing playlist.
