...
See Also
Errors
AVFoundation / AVFoundationErrorDomain
Global Variable
...
static var autoWhiteBalanceNotLocked: AVError.Code
...
Your app can’t change device settings because another process currently controls the devic
...
static var followExternalSyncDeviceTimedOut: AVError.Code
...
static var noSmartFramingsEnabled: AVError.Code
...
The operation couldn’t finish because there isn’t enough memory available to process the
media.
...
The operation attempted to write a new MPEG-4 segment that didn’t start with a sync samp
...
The user information key to retrieve a Boolean value that indicates whether recording finishe
successfully.
