...
The userInvitations resource represents users who have been invited to join a team in the
Apple Developer website. When you create a user invitation the user receives an email with a link 
activate an account and connect it to their Apple Account.
...
Enterprise Program API / User Invitations
API Collection
User Invitations
Email invitations to join your Enterprise Program team.
