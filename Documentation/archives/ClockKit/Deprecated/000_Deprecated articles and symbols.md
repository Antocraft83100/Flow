# 000_Deprecated articles and symbols.pdf
...
Preserve battery life and improve performance on the watch by providing a timeline with
...
Articles
Other Symbols
ClockKit / Deprecated articles and symbols
API Collection
...
Create complications that batch-load a timeline of future entries and run periodic backgroun
sessions to update the timeline.
SwiftUI templates
...
Utilitarian
Use the utilitarian templates to display content on a variety of watch faces, including the
Utility, Chronograph, Simple, and character watch faces.
Graphic
