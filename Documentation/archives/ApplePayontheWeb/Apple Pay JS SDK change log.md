# Apple Pay JS SDK change log.pdf

## Page 1

With the Apple Pay JS SDK, you can accept Apple Pay payments from customers on your website
Use this changelog to learn about feature updates, deprecations, and removals. You can learn mo
about Apple Pay JS version numbers and how to automatically link the latest available version in
...
sha384-DZRWMZLyVXr+7shJfal8pIG2v4KisLoSWFjZQMUv0+GWaCwoa82qeHsWrb
BIUDP
Overview
1.3.2
Apple Pay on the Web / Apple Pay JS change log
Article
...
Fixed
Fixed the oncancel callback that wasn’t triggered when closing a modal before a scan.
Added
...
sha384-kVWHV5PiZFlm9mRpZgyyprD3/PPkKg9gZ7z9TCHnvEkrYmFg/7nfpvTztecx
MZvw
1.3.1
