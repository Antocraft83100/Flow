# 006_CFHTTPAuthenticationGetTypeID__.pdf
...
See Also
HTTP Authentication
CFNetwork / CFHTTPAuthenticationGetTypeID()
Function
CFHTTPAuthenticationGetTypeID()
Gets the Core Foundation type identifier for the CFHTTPAuthentication opaque
type.
iOS 2.0+
iPadOS 2.0+
Mac Catalyst 13.1+
