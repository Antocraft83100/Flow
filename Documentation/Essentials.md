...
Learning SwiftUI
Important
This tutorial no longer demonstrates current SwiftUI or Xcode practices. For
tutorials supporting the latest OS and tools releases, see Develop in Swift.
Get started
Chapter 1
App principles
Walk through the building blocks of a SwiftUI app.
App principles
View layout
State and data flow
Resources
...
Chapter 2
View layout
Display content in views that adapt to their environment.
Chapter 3
State and data flow
Delve into the principles of managing app state and data
flow.
Resources
Explore other resources to learn more about creating amazing apps with
SwiftUI.
...
Documentation
Browse and search detailed API
documentation.
App organization
Model data
View fundamentals
...
View more 
Sample Code
More ready-made code samples to build and
learn from.
Introducing SwiftUI
...
Xcode and SDKs
Download Xcode 14 or later
for the latest tools and
SDKs.
View downloads 
Videos
Watch presentations about
SwiftUI from WWDC and
other events.
Demystify SwiftUI
...
Chapter 1
Navigating Apps
Learn SwiftUI fundamentals, such as navigating
between views and providing data to those views.
Navigating Apps
Presenting Content
Retrieving Content from a
Server
...
Chapter 2
Presenting Content
Organize your visual content in a resizable grid layout,
from arranging rectangles to managing a dynamic
collection of images from a photo library.
Chapter 3
Retrieving Content from a Server
Keep your app responsive while fetching and displaying
data from a server.
Chapter 4
Responding to User Input
Tap into device capabilities, such as motion sensors and
Multi-Touch gestures, to bring your app to life.
...
Chapter 5
Capturing and Displaying Photos
Take photos with the camera, add them to your photo
library, and display them.
Chapter 6
Get Started with Machine Learning
Walk through the fundamentals of machine learning.
